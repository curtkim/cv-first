...
from rgbd_pc.geometry_utils import *

# Load images
rgb = cv2.cvtColor(cv2.imread('data/rgb_0_057660.png'), cv2.COLOR_BGR2RGB)

# Depth is stored as float32 in meters
#depth = cv2.imread('data/depth.exr', cv2.IMREAD_ANYDEPTH)
depth = cv2.imread('data/depth_0_057660.exr', cv2.IMREAD_ANYDEPTH)
print(depth.dtype, depth.shape, depth.ndim)
#print(_depth.dtype, _depth.shape, _depth.ndim)
#depth = _depth.astype(int)
